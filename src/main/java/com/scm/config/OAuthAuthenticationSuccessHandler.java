	...
	public void onAuthenticationSuccess(
      ...
      user.setEnabled(true);
       ...
       if(authorizedClientRegistrationId.equalsIgnoreCase("google")) {
    	 ...
    	 //github
    	   String email=oauthUser.getAttribute("email")!=null ? oauthUser.getAttribute("email").toString():oauthUser.getAttribute("login")+"@gmail1.com";
    	   ...
    	   user.setName(name);
    	   user.setProvideUserId(ProvideUserId);
...
//      logger.info(user.getAuthorities().toString());
      ...
      //create user and save to databse
